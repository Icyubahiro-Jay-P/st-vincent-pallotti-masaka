...
import { programs, programHref } from "@/lib/site-config"
      ...
      <section className="border-b border-border bg-background py-16 sm:py-20">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-4 sm:px-6 lg:grid-cols-3 lg:px-8">
          <div className="flex flex-col gap-4 lg:col-span-1">
            ...
            <Button
              render={<Link href={`/admissions?program=${encodeURIComponent(program.name)}`} />}
